...
{
	HTREEITEM hRoot = m_wndClassView.InsertItem(_T("Log Analyzer"), 0, 0);
...
HTREEITEM CClassView::InsertLogFile(const CString& strFile)
{
    HTREEITEM hRoot = m_wndClassView.GetRootItem();
    HTREEITEM hFile = m_wndClassView.InsertItem(strFile, 1, 1, hRoot);
    return hFile;
}

void CClassView::InsertComponent(const HTREEITEM hFile, const CString& strComponent)
{
    m_wndClassView.InsertItem(strComponent, 1, 1, hFile);
}

void CClassView::RemoveLogFile(const CString& strFileName)
{
    m_wndClassView.RemoveLogFile(strFileName);
}